<%-- 
    Document   : indexx
    Created on : 20/09/2021, 12:28:33 p. m.
    Author     : PERSONAL
--%>
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="Servletlogin" method="POST" id="quickForm">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
              <button type="submit"  id="btnlogin" name="btnlogin" class="btn btn-primary btn-block btnhover">Sign In</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
...
<!-- Bootstrap 4 -->
<script src="plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- jquery-validation me saca error-->
